...
find_path (ASSIMP_INCLUDE_DIR NAMES scene.h
	#HINTS
	#NO_DEFAULT_PATH
	...
	PATH_SUFFIXES lib lib64 win32/Dynamic_Release "Win32/${MSVC_YEAR_NAME}/x64/Release" "Win32/${MSVC_YEAR_NAME}/Win32/Release" assimp
...
if (ASSIMP_FOUND)
  message(STATUS "-- Found Assimp libraries: ${ASSIMP_LIBRARIES}, library: ${ASSIMP_LIBRARY}")
  mark_as_advanced (ASSIMP_INCLUDE_DIR ASSIMP_INCLUDE_DIRS ASSIMP_LIBRARY ASSIMP_LIBRARIES)
endif()
